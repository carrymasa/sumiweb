        ...
        <div class="row">
          <div class="col-6">
            ...
            <p class="example">
              ...
              者がどれだけ人と関わったかという社会活動量を計測する手法を提案する。当人の社会的
              な場への参与の深さを測るために、検出された顔ごとの近接性と時間継続性の重みづけを
              行う。応用として、日々の社会活動による孤独感や疲労感に関わる社会的健康の計量と軽
              減を試みる。
            </p>
          </div>
          <div class="col-6">
        ...
        <div class="row">
          <div class="col-6 col-sm-6">
            ...
            <p class="example">
              ...
              元のレイアウトから1ページずらした構成と元の構成の2種類の見開き構成のマンガを用意し、視線計測装置を用いて読んでいる際の視線移動を分析する。
